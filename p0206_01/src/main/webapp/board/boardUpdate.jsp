...
<body>
  ...
  <div class="write-container">
    ...
    <form action="./doBoardUpdate.do" name="frm" method="post" class="write-form" id="writeForm">
      ...
      <input type="text" name="id" id="writer" value="${board.id}" maxlength="20" required />
      <input type="text" name="btitle" id="title" value="${board.btitle}" maxlength="100" required />
      <textarea name="bcontent" id="content" maxlength="2000" required>${board.bcontent}</textarea>
